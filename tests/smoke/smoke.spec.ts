...
test.describe('Registration, Login with UI, @ui', () => {
  ...
  test('Validate Contact List table headers', async ({
    ...
    await loginPageSteps.openLogin();
    await loginPageSteps.login(dataStore.get('EMAIL'), 'Password1!');
